...
<html>
<head>
<link rel="stylesheet" href="ques12.css">
...
<BODY 
	...
	The number of elements that can be sorted<br> in &theta;(logn) time using heap sort is
	</div>
	</center>
	</div>
...
<ul id="list" onclick="lang1(event);">
  <li>&theta;(1)</li>
  <li>&theta;(sqrt(logn))</li>
  <li>&theta;(Log n/(Log Log n))</li>
  <li>&theta;(Log n)</li>
</ul>
</div>
<div class="shiny-btn" onclick="window.location='ans12.jsp?t='+t+'&as='+ans">Submit</div>
</body>
<script type="text/javascript">
