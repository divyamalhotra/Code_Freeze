...
<html>
<head>
<link rel="stylesheet" href="ques23.css">
...
// String str="Abbb";
  ...
  stat.executeUpdate("Update c_team set Q_id='L23' where team_name='"+str+"'");
  /* if(frz==1)
	{
...
<BODY  
  ...
  <center> <div class="ques">Stack A has the entries a, b, c (with a on top). Stack B is empty. An entry popped out of stack A can be printed immediately or pushed to stack B. An entry popped out of the stack B can be only be printed. In this arrangement, which of the following permutations of a, b, c are not possible?</div></center>   
...
<div class="shiny-btn" onclick="window.location='ans23.jsp?t='+t+'&as='+ans">Submit</div>

  <!--<div class="option1 ">
    <input type="checkbox" class="checkbox" id="checkbox"><label for="checkbox"> Address of main</label>
  </div>

      <button class="btn third col-sm-3" style=" width:400px; margin-left:200px;  font-size:25px; margin-top:25px;"  >Address of <br>main function</button>
      <button class="btn third col-sm-3" style=" width:400px; margin-left:200px; font-size:25px; margin-top:25px;" >Invalid</button>
      <button class="btn third col-sm-3" style=" width:400px; margin-left:200px; font-size:25px; margin-top:25px;">Main gets recursively<br> called</button>
      <button class="btn third col-sm-3" style=" width:400px; margin-left:200px; font-size:25px; margin-top:25px;">xyz</button>
    </div>
-->
