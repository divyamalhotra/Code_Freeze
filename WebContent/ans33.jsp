...
try 
{
 ...
 //String str="Abbb";
  ...
  stat.executeUpdate("Update C_team set time='"+tim+"' where team_name='"+str+"'");
	...
	stat.executeUpdate("Update c_team set Q_id='LLL' where team_name='"+str+"'");
	stat.executeUpdate("Update c_team set active=0 where team_name='"+str+"'");
