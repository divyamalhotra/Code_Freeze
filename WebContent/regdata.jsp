...
try 
{
  ...
  stat1.executeUpdate("insert into C_team values('"+teamname+"','L0',0,0,1,1200)");
  stat.executeUpdate("insert into C_REGISTER(TEAM_NAME,EMAIL_ID,CONTACT_NO,MEM1_FIRSTNAME,MEM1_LASTNAME,MEM2_FIRSTNAME,MEM2_LASTNAME,COLLEGE) values('"+teamname+"','"+email+"','"+phone+"','"+mem1+"','"+mem1_last+"','"+mem2+"','"+mem2_last+"','"+cllg+"')");
 ...
 stat2.executeQuery("insert into STORE values('"+teamname+"','"+count+"','0',2700)");*/
  RequestDispatcher rd =request.getRequestDispatcher("/instructions.html");
