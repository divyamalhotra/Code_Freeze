...
<html>
<head>
<link rel="stylesheet" href="ques21.css">
...
try 
{
 ...
 //String str="Abbb";
  ...
  stat.executeUpdate("Update c_team set Q_id='L21' where team_name='"+str+"'");
  /* if(frz==1)
	{
...
<BODY 
  ...
  <center> <div class="ques">Find the output.<br>Assume that the size of int is 4. </div></center>   
...
<div class="shiny-btn" onclick="window.location='ans21.jsp?t='+t+'&as='+ans">Submit</div>
