...
<html>
<head>
<link rel="stylesheet" href="ques22.css">
...
try 
{
 ...
 //String str="Abbb";
  ...
  stat.executeUpdate("Update c_team set Q_id='L22' where team_name='"+str+"'");
  /* if(frz==1)
	{
...
<BODY 
  ...
  <center> <div class="ques">Find the output.<br></div></center>   
  <center><div class="code">
            

int main()<br>
{<br>
    const char* p = "12345";<br>
    const char **q = &p;<br>
    *q = "abcde";<br>
    const char *s = ++p;<br>
    p = "XYZWVU";<br>
...
<div class="shiny-btn" onclick="window.location='ans22.jsp?t='+t+'&as='+ans">Submit</div>
