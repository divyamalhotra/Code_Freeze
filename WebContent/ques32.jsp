...
<html>
<head>
<link rel="stylesheet" href="ques32.css">
...
try 
{
 ...
 //String str="Abbb";
  ...
  stat.executeUpdate("Update c_team set Q_id='L32' where team_name='"+str+"'");
  /* if(frz==1)
	{
...
<BODY
	...
	<center><img src="two.svg.png" height="200px"></center>
	
      <div class="panel-heading" >
  <center> <div class="ques"> What does the function print() do in general? </div></center>   
...
void print(struct node *root, int k)<br>
{<br>
    if (root != NULL && count <= k)<br>
    {<br>
        print(root->right, k);<br>
        count++;<br>
        if (count == k)<br>
          printf("%d ", root->data);<br>
       print(root->left, k);<br>
    }<br>
}<br>
...
<ul id="list" onclick="lang1(event);">
  <li>Prints the kth smallest element in BST</li>
  <li>Prints the kth largest element in BST</li>
  <li>Prints the leftmost node at level k from root</li>
  <li>Prints the rightmost node at level k from root</li>
</ul>
</div>
<div class="shiny-btn" onclick="window.location='ans32.jsp?t='+t+'&as='+ans">Submit</div>
